...
public abstract class GameLevelDefaultImpl extends Thread implements GameLevel,Cloneable {
	...
	public GameLevelDefaultImpl clone() throws CloneNotSupportedException{
		
		return (GameLevelDefaultImpl) super.clone();
	}
